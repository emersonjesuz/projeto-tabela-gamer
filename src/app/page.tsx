  ...
  return (
    <Animacao>
      <main className="flex  flex-col items-center  w-full   pt-5 bg-pretoCarvao">
        <div className="flex  flex-col items-center p-2 lg:py-10 w-full rounded-t-2xl lg:rounded-t-[100px]  bg-[#f2f2f2]">
          <div className="flex flex-col lg:flex-row  gap-10 w-full lg:w-[80%]">
            <Top3Equipes
              equipes={[1, 2, 3]}
              link="/"
